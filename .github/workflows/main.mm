...
- (UIButton *)createStyledButton:(NSString *)title frame:(CGRect)frame colorHex:(NSString *)hex {
    ...
    UIColor *color = [UIColor colorWithRed:((rgbValue & 0xFF0000) >> 16)/255.0 green:((rgbValue & 0x00FF00) >> 8)/255.0 blue:(rgbValue & 0x0000FF)/255.0 alpha:1.0];
    
    [btn setTitleColor:color forState:UIControlStateNormal];
    btn.backgroundColor = [UIColor colorWithRed:0.12 green:0.05 blue:0.22 alpha:1.0];
